...
#         markerfacecolor=colors['gray'], markeredgewidth=0.5)
#         ax[4].plot(g[0], arch['effective_hill'], 's', color=op_colors[g[1]], 
#                    ms=4, markerfacecolor=colors['gray'], markeredgewidth=0.5 )
...
if ALL_DATA == 0:
    plt.savefig('../figs/properties_data_alone.pdf', bbox_inches='tight')
else:
