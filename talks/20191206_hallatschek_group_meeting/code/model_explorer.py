...
bokeh.plotting.output_file("../figs/model_explorer.html", mode="inline")
...
p_fc.circle(x='c', y='mut_fc', source=source, view=view,
            color=colors['orange'], line_width=2, size=8, legend='mutant strain')
...
title='DNA binding energy [kT]', bar_color=colors['light_purple'])
ref_R_slider = Slider(start=1, end=2000, value=260, step=1,
title='Repressors per cell', bar_color=colors['light_purple'])
ref_epAI_slider = Slider(start=-10, end=10, value=4.5, step=0.1,
title='Allosteric state energy difference [kT]', bar_color=colors['light_purple'])
ref_ka_slider = Slider(start=-2, end=3.7, value=np.log10(139), step=0.1,
    title='Log10(Ka/1µM)', bar_color=colors['light_purple'])
ref_ki_slider = Slider(start=-3, end=2.7, value=np.log10(0.53), step=0.01,
    title='Log10(Ki/1µM)', bar_color=colors['light_purple'])
ref_n_slider = Slider(start=1, end=10, value=2, step=1,
    title='Number of allosteric sites', bar_color=colors['light_purple'])
...
mut_ka_slider = Slider(start=-2, end=3.7, value=np.log10(139), step=0.01,
    title='Log10(Ka / 1µM)', bar_color=colors['light_orange'])
mut_ki_slider = Slider(start=-3, end=2.7, value=np.log10(0.53), step=0.01,
    title='Log10(Ki / 1µM)', bar_color=colors['light_orange'])
