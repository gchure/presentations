...
for m, idx in IND_corr.items():
        ax[0, idx].set_title(m, fontsize=8, y=1.03, bbox=title_bbox) 

        ax[0, idx + 4].set_title(m, fontsize=8, y=1.03, bbox=title_bbox)
        ax[-1, idx].set_xlabel('IPTG [$\mu$M]', fontsize=6)
        ax[-1, idx + 4].set_xlabel('IPTG [$\mu$M]', fontsize=6)
...
for m, idx in DNA_corr.items():
        ax[idx, 0].text(-0.7, 0.42, m, fontsize=8,rotation='vertical', 
            transform=ax[idx, 0].transAxes, bbox=title_bbox)
        ax[idx, 4].text(-0.7, 0.42, m, fontsize=8,rotation='vertical', 
            transform=ax[idx, 4].transAxes,  bbox=title_bbox)
